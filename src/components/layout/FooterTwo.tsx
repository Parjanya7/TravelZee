...
const FooterTwo = () => {
  return (
    <footer
      className="footer_style__two lg:pt-[60px] pt-11 bg-cover bg-center bg-no-repeat"
        ...
        <div className="lg:grid grid-cols-12 pb-20 lg:pb-12">
          <div className="flex col-span-7 lg:justify-between lg:space-x-5 space-x-3 flex-wrap md:flex-nowrap">
            ...
            <div className="grow md:basis-1/3 mt-base">
              ...
              <ul className="footer-link-list-v2">
                ...
                <li>
                  <Link href="/faq" className="footer-nav-link-v2">
                    Call To Kindness
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/blog-list" className="footer-nav-link-v2">
                    Blog{" "}
                  </Link>
                </li>
                <li>
          ...
          <div className="col-span-5 md:grid grid-cols-12 gap-base">
            <div className="flex-grow max-w-[341px] mt-base lg:col-span-7 md:col-span-6">
              <h3 className="text-white lg:text-[25px] text-2md  font-semibold leading-1.35 mb-base">
                Business Inquiry
              </h3>
              <ul>
                <li className="mt-5 first:mt-0 flex items-center text-stock-1 hover:text-primary-1 duration-200">
                  ...
                  <Link
                    href="#"
                    className="leading-1.5 pl-[10px] lg:text-base text-sm"
                  >
                    3891
              ...
              <h3 className="text-white lg:text-[25px] text-2md  font-semibold leading-1.35 mt-11">
                Newsletter
              </h3>
              <form action="#" className="mt-5 ">
                ...
                <button
                  type="submit"
                  className="text-base text-white font-semibold bg-primary-1 w-full mt-5 h-[50px]"
                >
                  Subscribe
                </button>
              </form>
            ...
            <div className="md:basis-2/5 mt-base lg:col-span-5 md:col-span-6">
              ...
              <ul>
                <li className="first:mt-0 mt-3">
                  <Link
                    ...
                    className="flex items-center lg:text-base text-sm text-stock-1 hover:text-primary-1 duration-200"
                  >
              ...
              <ul className="flex items-center flex-wrap space-x-[15px]">
                <li className="mt-3">
                  <Link
                    href={FooterDataOne?.facebookLink}
                    className="flex items-center justify-center rounded-full bg-[#1674EA] h-10 w-10 text-white hover:-translate-y-1 duration-200"
                  >
                ...
                <li className="mt-3">
                  <Link
                    href={FooterDataOne?.youtubeLink}
                    className="flex items-center justify-center rounded-full bg-[#F70000] h-10 w-10 text-white hover:-translate-y-1 duration-200"
                  >
                ...
                <li className="mt-3">
                  <Link
                    ...
                    className="flex items-center justify-center rounded-full bg-[#CF2872] h-10 w-10 text-white hover:-translate-y-1 duration-200"
                  >
          ...
          <div className="flex md:justify-between flex-wrap text-dark-5 lg:text-base text-sm gap-6 text-center lg:text-start justify-center">
            ...
            <div className="flex flex-wrap items-center order-1 lg:order-2">
              ...
              <div className="ml-[15px]">
                <img
                  src="/assets/images/others/payment-cards.png"
                  alt="cards"
                />
              </div>
            </div>
