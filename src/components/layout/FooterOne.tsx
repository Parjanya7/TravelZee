...
const FooterOne = () => {
    ...
    return (
        <div className="footer_style__one bg-center bg-cover bg-no-repeat mt-1 pt-17 bg-fixed overflow-hidden" style={{ background: `linear-gradient( rgba(8, 8, 11, .8) 100%, rgba(8, 8, 11, .8)100%), url("${FooterDataOne.bgImg}")` }}>
            <div className="container">
                ...
                <div className="grid lg:grid-cols-12 lg:pt-17 pt-10 gap-base lg:pb-17 pb-12 gradient-border-top">
                    <div className="lg:col-span-4 col-span-12 text-center lg:text-start">
                        ...
                        <form onSubmit={handleSubmit} action="#" className="mt-5 md:max-w-[345px] max-w-[300px] lg:mx-0 mx-auto">
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute left-5 max-w-5 top-1/2 -translate-y-1/2">
                                    <Image width={17} height={17} alt='person' src="/assets/images/person.png" />
                                </div>
                            </div>
                            <div className="relative">
                                ...
                                <div className="absolute left-5 max-w-5 top-1/2 -translate-y-1/2">
                                    <Image width={17} height={17} alt='person' src="/assets/images/phone.png" />
                                </div>
                            </div>
                            <div className="relative">
                                <input
                    ...
                    <div className="lg:col-span-8 col-span-12 gap-base flex lg:flex-nowrap flex-wrap text-center lg:text-start lg:justify-between justify-center lg:pl-8">
                        <div className="flex-grow">
                            <div className="mb-base">
                                <h3 className="text-white lg:text-[25px] text-2md font-semibold lg:leading-1.35">Get to Know Us</h3>
                            </div>
                        ...
                        <div className="flex-grow">
                            <div className="mb-base">
                                <h3 className="text-white lg:text-[25px] text-2md font-semibold lg:leading-1.35">Policies
                                </h3>
                            </div>
                            <ul className="footer-link-list">
