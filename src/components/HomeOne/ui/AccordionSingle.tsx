  ...
  return (
    <div className="single__accordion shadow-custom-1 bg-white">
      <button
        ...
        type="button"
        className="toggle px-5 py-5 leading-1.5 text-2md text-start w-full text-dark-1 font-serif"
      >
        {" "}
      ...
      >
        <p className="text-base font-sans text-dark-3 leading-1.9">{content}</p>
      </div>
    </div>
  );
};
