...
const PackageTwo = ({ handleSubscribe }: { handleSubscribe: any }) => {
  const pagination = {
    el: ".pack-two-pagi",
  };
  ...
  return (
    <div className="package_style__two lg:pt-30 pt-24 pb-24 lg:pb-30 z-1 relative">
      <div
        className="absolute top-[3%] left-[2%] max-w-[9%] z-minus lg:inline-block hidden wow fadeInLeft"
        data-wow-delay="0.3s"
      >
        <img
      ...
      <div
        className="absolute top-[2%] right-[1%] max-w-[14%] z-minus lg:inline-block hidden wow fadeInRight"
        data-wow-delay="0.3s"
      >
        <img
          src="./assets/images/illustration/leaf-illustration-2.png"
          alt="leaf"
        />
      </div>
