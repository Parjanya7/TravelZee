...
const AboutTwo = () => {
  return (
    <div className="about_style__two lg:py-30 py-24 relative z-1">
      ...
      <div className="container">
        <div className="grid lg:grid-cols-12 gap-base items-center">
          <div className="lg:col-span-6">
            <div
              className="inline-block p-base border-dark-2 border wow fadeIn"
              data-wow-delay="0.2s"
            >
              <img
                src="./assets/images/about/about2-1.webp"
                alt="about-image"
              />
            </div>
          </div>
          <div className="lg:col-span-6 text-white">
            <h5 className="font-cursive text-2md leading-1.5">
              {AboutDataTwo.sub_title}
            </h5>
