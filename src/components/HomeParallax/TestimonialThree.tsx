              ...
              <SwiperSlide key={testimonial.id}>
                <div className="grid grid-cols-12 gap-6 items-center">
                  <div className="lg:col-span-4 col-span-12 lg:order-1 order-2 text-center">
                    ...
                    <h5 className="lg:text-lg text-2md font-semibold text-dark-1 mt-4">
                      {testimonial.reviewer}
                    </h5>
                    <p className="text-dark-2 mt-1">
                  ...
                  <div className="lg:col-span-8 col-span-12 lg:order-2 order-1">
                    <div>
                      <div className="lg:mb-6 mb-4">
                        <svg
                          className="lg:max-w-[30px] max-w-[20px]"
                          width={30}
                          height={27}
                          viewBox="0 0 30 27"
                          fill="none"
                      ...
                      <div className="text-end">
                        <svg
                          className="ml-auto lg:max-w-[30px] max-w-[20px]"
                          width={30}
                          height={27}
                          viewBox="0 0 30 27"
                          fill="none"
