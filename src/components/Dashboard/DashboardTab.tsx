      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 grid-cols-1 gap-4">
        <div className="col-span-1">
          <div className="bg-[#FFF2ED] bg-opacity-30 py-5 px-5 flexjustify-center items-center flex gap-4 ">
            ...
            <div>
              <h5 className="font-semibold lg:text-2xl text-2xl leading-[1]">
                10
              </h5>
                ...
                <tr key={booking.id}>
                  ...
                  <td>
                    {booking.status === "pending" ? (
                      <span className="tag panding bg-[#17A2B8] text-white">
                        Pending
                      </span>
                    ) : null}
                    {booking.status === "canceled" ? (
                      <span className="tag panding bg-red-500 text-white">
                        Canceled
                      </span>
                    ) : null}
