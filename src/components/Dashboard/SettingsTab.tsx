    ...
    <div className="border border-primary-1 border-opacity-20 lg:py-6 py-4 lg:px-6 px-6">
      ...
      <div className="pt-4">
        <ul className="flex gap-8 lg:text-md text-base font-medium">
          <li
            onClick={() => setTab("info")}
            className={`cursor-pointer border-b ${tab === "info" ? " text-primary-1 border-primary-1" : "text-gray-500"}`}
          >
            Personal Information
          </li>
          <li
            onClick={() => setTab("password")}
            className={`cursor-pointer border-b ${tab === "password" ? " text-primary-1 border-primary-1" : "text-gray-500"}`}
          >
            Change Password
          </li>
        </ul>
