  ...
  return (
    <>
      <ul id="tabs-nav" className="booking-tabs flex gap-4 pb-6">
        <li className="tab-link active basis-1/2" data-tab={3}>
          Booking
        </li>
        <li className="tab-link basis-1/2" data-tab={4}>
          Enquiry
        </li>
      </ul>
      <div id="tab-3" className="tab-content active">
        ...
        >
          ...
          <div className="pt-4">
            ...
            <div className="custom-checkbox mt-4">
              ...
              <label htmlFor="add-two">
                Add Service per day - <span className="font-semibold">$10</span>
              </label>
            </div>
          </div>
          ...
          <button className="capitalize w-full text-center underline duration-150 mt-4 text-dark-1 font-medium flex items-center justify-center hover:text-primary-1">
            check availability{" "}
          </button>
          <Link
            href="booki"
      ...
      <div id="tab-4" className="tab-content">
        <form
          action="#"
          className="lg:px-base px-5 lg:py-base py-5 bg-white border-primary-1 border"
        >
          <h4 className="lg:text-lg text-2md text-dark-1 font-semibold">
            Enquiry Now
          </h4>
          <p className="regular-text-v1 !leading-[1.62] mt-2">
      ...
      <aside className="widget widget_social lg:mt-[50px] mt-10">
        ...
        <ul>
          <li className="inline-block mt-4 lg:mr-7 mr-5 last:mr-0">
            <a href="#" className="primary_social__icon">
