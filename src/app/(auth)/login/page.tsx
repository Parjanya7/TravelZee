...
const login = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          'linear-gradient(to right, rgba(30, 30, 30, .3), rgba(30, 30, 30, .3)), url("/assets/images/hero/h4.webp")',
      }}
    >
        ...
        <div className="mx-auto bg-white w-full px-base py-base">
          ...
          <ul id="tabs-nav" className="login-tabs flex gap-4 pt-6">
            <li className="basis-1/2">
              <Link href="#" className="tab-link-button active">
                Sign In
              </Link>
            </li>
            <li className="basis-1/2">
              <Link href="/signup" className="tab-link-button">
                Sign Up
              </Link>
            </li>
          </ul>
          ...
          <div className="lg:mt-5 mt-4 flex gap-2 items-center">
            <input
              type="checkbox"
              id="logincheck"
              className="h-4 w-4 rounded-md border-primary-1 border"
            />
            <label htmlFor="logincheck" className="text-dark-2">
              Remember me
            </label>
          </div>
          <button
