...
export const metadata: Metadata = {
  title:
    "Destination Details | Arid - Travel & Tourism HTML/Tailwind CSS Template",
            ...
            <div className="lg:col-span-8 col-span-12">
              <div className="disc__wrapper">
                ...
                <p>
                  ...
                  imperdiet cu vel. Sit cu stet autem eligendi, eros reprimique
                  mel id, no pri tation altera. At soluta fierent laboramus
                  eum.Nam at dicant deterruisset.
                </p>
                  ...
                  <li>
                    ...
                    <div className="list__content">
                      ...
                      <p>
                        ...
                        sensibus cotidieque. Ne per malorum vivendum principes,
                        congue imperdiet cu vel. Sit cu stet autem eligendi,
                        eros reprimique mel id, no pri tation altera. At soluta
                        fierent laboramus eum.
                      </p>
                    </div>
                  </li>
                </ol>
                <div className="grid grid-cols-8 lg:gap-base gap-4 lg:pt-[10px] lg:pb-9 pb-6">
                  <a
                    href="./assets/images/details/des-disc-3.webp"
                    className="col-span-3"
                    data-fancybox="gallery"
                  >
                    <img
                      src="./assets/images/details/des-disc-3.webp"
                      alt="destination"
                      className="w-full max-h-[260px] object-cover"
                    />
                  </a>
                  <a
                    href="./assets/images/details/des-disc-4.webp"
                    className="col-span-5"
                    data-fancybox="gallery"
                  >
                    <img
                      src="./assets/images/details/des-disc-4.webp"
                      alt="destination"
                      className="w-full max-h-[260px] object-cover"
                    />
                  </a>
                  <a
                    href="./assets/images/details/des-disc-5.webp"
                    className="col-span-3"
                    data-fancybox="gallery"
                  >
                    <img
                      src="./assets/images/details/des-disc-5.webp"
                      alt="destination"
                      className="w-full max-h-[260px] object-cover"
                    />
                  </a>
                  <a
                    href="./assets/images/details/des-disc-6.webp"
                    className="col-span-2"
                    data-fancybox="gallery"
                  >
                    <img
                      src="./assets/images/details/des-disc-6.webp"
                      alt="destination"
                      className="w-full max-h-[260px] object-cover"
                    />
                  </a>
                  <a
                    href="./assets/images/details/des-disc-7.webp"
                    className="col-span-3"
                    data-fancybox="gallery"
                  >
                    <img
                      src="./assets/images/details/des-disc-7.webp"
                      alt="destination"
                      className="w-full max-h-[260px] object-cover"
                    />
                  </a>
                ...
                <form action="#" className="pt-3">
                  <h3 className="lg:text-2xl md:text-xl text-lg text-dark-1 leading-[1.42] font-medium mt-[10px] mb-[14px]">
                    Post A Comments
                  </h3>
