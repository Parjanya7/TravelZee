            ...
            <div className="lg:col-span-8 col-span-12">
              <ul className="bg-white lg:px-base px-5 lg:py-6 py-5 flex lg:overflow-hidden overflow-x-scroll lg:mt-[-40px] mt-base border">
                <li className="grow py-1 border-r border-primary-1 last:border-none px-5">
                  <a
                    href="#Information"
                    className="flex items-center text-dark-2 justify-center duration-200 hover:text-primary-1 font-medium"
                  >
                ...
                <li className="grow py-1 border-r border-primary-1 last:border-none px-5">
                  ...
                  >
                    <div className="shrink-0 mr-2">
                      ...
                      >
                        <path
                          d="M14.4082 3.45008L14.3499 6.60839C14.3415 7.04172 14.6166 7.61674 14.9666 7.87507L17.0332 9.44172C18.3582 10.4417 18.1416 11.6667 16.5582 12.1667L13.8666 13.0084C13.4166 13.1501 12.9416 13.6417 12.8249 14.1001L12.1832 16.5501C11.6749 18.4834 10.4082 18.6751 9.35821 16.9751L7.89154 14.6001C7.62487 14.1667 6.99154 13.8417 6.49154 13.8667L3.70824 14.0084C1.71657 14.1084 1.1499 12.9584 2.4499 11.4417L4.09988 9.52506C4.40821 9.16672 4.54988 8.50007 4.40821 8.05007L3.56659 5.35839C3.07492 3.77506 3.95824 2.90007 5.53324 3.41674L7.99158 4.22507C8.40825 4.3584 9.03324 4.26673 9.38324 4.0084L11.9499 2.15839C13.3333 1.15839 14.4415 1.74174 14.4082 3.45008Z"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M18.2584 18.3333L15.7334 15.8083"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
              ...
              <div className="pack__disc" id="Information">
                ...
                <p>
                  ...
                  invenire iracundia vim. En eam dico similique, ut sint posse
                  sit, eum sumo diam ea. Liber consectetuer in mei, sea in
                  imperdiet assueverit contentiones, an his cibo blandit
                  tacimates. Iusto iudicabit similique id velex, in sea rebum
                  deseruisse appellantur. Lorem ipsum Alienum phaedrum torquatos
                  nec eu, vis detraxit pericu in mei, vix aperiri vix at,dolor
                  sit amet.
                </p>
                <ul className="pack__list">
                  <li>
                    <i className="bi bi-clock" /> 4 Days / 5 Night
                  </li>
                  <li>
                    {" "}
                  ...
                  <div>
                    ...
                    <div className="flex single__count">
                      ...
                      <div className="lg:ml-[18px] ml-4 pb-8">
                        ...
                        <ul>
                          <li>
                            <i className="bi bi-check-circle" /> Professional
                            Tour Guide
                          </li>
                          <li>
                    ...
                    <div className="flex single__count">
                      ...
                      <div className="lg:ml-[18px] ml-4 pb-8">
                        ...
                        <ul className="list-sm">
                          <li>
                            <i className="bi-check2" /> 3 Nights Accommodation
                          </li>
                          <li>
                            <i className="bi-check2" /> 2 Meals / day
                          </li>
                          <li>
                            <i className="bi-check2" /> Breakfast
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="accordion lg:space-y-6 space-y-5">
                    <div className="single__accordion border border-stock-1">
                      ...
                      <div className="hidden inner px-5 pb-5">
                        <p className="text-base font-sans text-dark-3 leading-1.9 !pb-0">
                          ...
                          most sublime: from the UFO-like dragon&apos;s blood
                          trees in Yemen to a rainbow-colored hot spring in
                          Yellowstone to a bridge in Germany that looks like a
                          leftover prop from Lord of the Rings.
                        </p>
                      </div>
                    </div>
                    <div className="single__accordion border border-stock-1">
                    ...
                    <div className="single__accordion border border-stock-1">
                      <button
                        ...
                        className="toggle px-5 py-3 leading-1.5 text-2md text-start w-full text-dark-1 font-serif font-semibold"
                      >
                        03. What are the most surreal places to visit in
                        Bangladash?
                      </button>
                      <div className="hidden inner px-5 pb-5">
                        <p className="text-base font-sans text-dark-3 leading-1.9 !pb-0">
