      ...
      <div className="lg:pt-20 pt-16">
        <div className="container">
          <ul className="flex items-center justify-between pb-10">
            <li
              className={`single-step-count justify-end step ${step >= 1 ? "active-count" : ""}`}
            >
              <span className="inline-flex justify-center items-center lg:h-10 lg:w-10 w-9 h-9 rounded-full bg-primary-1 text-white">
                01
              </span>
            ...
            <li
              className={`single-step-count justify-end step ${step >= 2 ? "active-count" : ""}`}
            >
              <span className="inline-flex justify-center items-center lg:h-10 lg:w-10 w-9 h-9 rounded-full bg-primary-1 text-white">
                02
              </span>
            ...
            <li className="flex-grow h-[1px] bg-stock-1 mx-3 sm:block hidden" />
            <li
              className={`single-step-count justify-end step ${step >= 3 ? "active-count" : ""}`}
            >
              <span className="inline-flex justify-center items-center lg:h-10 lg:w-10 w-9 h-9 rounded-full bg-primary-1 text-white">
                03
              </span>
                    ...
                    <div className="grid grid-cols-12 lg:gap-12 gap-base">
                      <div className="lg:col-span-8 col-span-12">
                        <div className="px-5 py-4 bg-primary-1 bg-opacity-20 text-dark-2 lg:text-base text-sm">
                          Sign in with your saved information to book, or{" "}
                          <a
                            href="auth.html"
                            className="font-semibold text-dark-1"
                          >
                            register
                          </a>{" "}
                          to manage your reservations on the go!
                        </div>
                        <h5 className="text-dark-1 lg:text-[22px] text-2md font-semibold mt-base mb-7">
                          Please tell us about yourself.
                        </h5>
                        <div className="grid grid-cols-2 lg:gap-7 gap-5">
                          <div className="col-span-2">
                            <label className="text-dark-2 block mb-2">
                              Full Name
                            </label>
                            <input
                              type="text"
                          ...
                          <div className="custom-checkbox col-span-2">
                            ...
                            <label htmlFor="agree2">
                              I agree to Arid Terms of Use and Privacy Policy.
                            </label>
                          </div>
                        </div>
                      </div>
                      <div className="lg:col-span-4 col-span-12">
                        ...
                        <div className="flex group pt-5">
                          <a
                            ...
                            className="shrink-0 lg:max-w-[134px] max-w-[100px] mr-[15px] overflow-hidden"
                          >
                            <img
                              src="./assets/images/packages/p1-1.webp"
                              alt="blogs"
                        ...
                        <div className="grid grid-cols-2 items-center">
                          <div className="col-span-1 border-r border-stock-1">
                            ...
                            <h5 className="lg:text-2md text-md font-semibold text-dark-1 pb-1">
                              Fri 29, Oct 2024
                            </h5>
                            <span className="text-sm text-dark-3">
                              Time :{" "}
                        ...
                        <div>
                          <div className="flex justify-between gap-3 lg:text-base text-sm">
                            <span className="grow text-dark-2">
                          ...
                          <div className="mt-2">
                            <a
                              href="#"
                              className="underline text-sm font-medium text-primary-1"
                            >
                              Want to traveling on different dates?
                            </a>
                          </div>
                  ...
                  <div className="tab">
                    <div className="grid grid-cols-12 lg:gap-12 gap-base">
                      <div className="lg:col-span-8 col-span-12">
                        ...
                        <div className="grid grid-cols-2 lg:gap-7 gap-5">
                          ...
                          <div className="lg:col-span-1 col-span-2">
                            ...
                            <input
                              type="text"
                              placeholder="1234 4568 1234 4567"
                              className="input_style__primary"
                            />
                          </div>
                          <div className="lg:col-span-1 col-span-2">
                      ...
                      <div className="lg:col-span-4 col-span-12">
                        ...
                        <ul className="pt-4">
                          <li className="flex justify-between gap-2 text-dark-1 mt-4">
                            <span>Double Bed Room x 1 </span>{" "}
                            <span className="font-semibold flex-shrink-0">
                              $100
                            </span>
                          </li>
                          <li className="flex justify-between gap-2 text-dark-1 mt-4">
                            <span>Total Travelers x 3 </span>{" "}
                            <span className="font-semibold flex-shrink-0">
                              $400
                            </span>
                          </li>
                    ...
                    <div className="flex mt-10 gap-8 justify-center">
                      <button
                        ...
                        type="button"
                        id="prevBtn"
                        className="btn_primary__v1 outlined mr-5"
                      >
                        Previous
                      </button>
                      <button
                ...
                return (
                  <div className="tab">
                    <div className="text-center max-w-[1000px] mx-auto">
                      ...
                      <h4 className="lg:text-lg text-2md font-semibold text-dark-2 mt-4">
                        Your order is on its way! <br /> Check your email for
                        delivery timing and order details
                      </h4>
                      <div className="mt-10 px-5 py-4 border border-primary-1 border-dashed">
                        <div className="grid lg:grid-cols-4 grid-cols-2 gap-4">
                          <div className="col-span-1 text-dark-3">
                            <p>Order Number</p>
                            <p className="mt-2 font-semibold text-dark-1 lg:text-md text-base">
                              123456
                            </p>
                          </div>
                          <div className="col-span-1 text-dark-3">
