...
const BlogDetails = () => {
  return (
    <>
      <Breadcrumb page="Blog Details" pageTitle="Our Beautiful Blog Details" />
          ...
          <div className="grid grid-cols-12 gap-base">
              ...
              <div className="blog__details">
                <div className="disc__header text-center lg:pb-7 pb-6 border-b border-stock-1 lg:mb-10 mb">
                  <div className="disc__thumb overflow-hidden">
                    <img
                      src="./assets/images/blog/blog-standard.webp"
                      alt="bs"
                      className="w-full"
                    />
                  </div>
                  ...
                  <h3 className="text-dark-1 font-medium leading-[1.43] lg:text-2xl md:text-xl text-[28px] mt-[14px]">
                    We spent 24 hours in Switzerland with Trafalgar Travel
                    Director
                  </h3>
                </div>
                <div className="disc__wrapper">
                  <h5 className="lg:text-2md text-md text-dark-2 font-medium leading-[1.5] font-sans mb-6">
                    Lorem omnes impedit ius, vel et hinc agam fabulas. Ut audiam
                    invenire iracundia vim. Tn eam dimo diam ea. Piber Korem sit
                    amet.
                  </h5>
                  <p>
                    Al elit omnes impedit ius, vel et hinc agam fabulas. Ut
                    audiam invenire iracundia vim. En eam dico similique, ut
                    sint posse sit, eum sumo diam ea. Liber consectetuer in mei,
                    sea in imperdiet assueverit contentiones, an his cibo
                    blandit tacimates. Iusto iudicabit similique id velex, in
                    sea rebum deseruisse appellantur. Lorem ipsum Alienum
                    phaedrum torquatos nec eu, vis detraxit pericu in mei, vix
                    aperiri vix at,dolor sit amet. blandit dicant definition.Sit
                    delicata persequeris ex, in sea rebum deseruisse
                    appellantur. Lorem ipsum dolor sit amet.Eos ei nisl graecis,
                    vix aperiri consequat an. Eius lorem.
                  </p>
                  <p>
                    Qui ad idque soluta deterruisset, nec sale pertinax mandamus
                    et. Eu mei soluta scriptorem dissentiet, cu vel sensibus
                    cotidieque. Ne per malorum vivendum principes, congue
                    imperdiet cu vel. Sit cu stet autem eligendi, eros
                    reprimique mel id, no pri tation altera. At soluta fierent
                    laboramus eum.Nam at dicant deterruisset.
                  </p>
                  <blockquote>
                    <p>
                      “Ei elit omnes impedit ius, vel et hinc agam fabulas. Ut
                      audiamre iracundia vim. An eame, ut sint posse sumo diam
                      ea. Cu omnis.”
                    </p>
                  ...
                  <div className="grid grid-cols-2 lg:gap-base gap-5 lg:pt-[10px] lg:pb-9 pb-6">
                    <div className="col-span-1">
                      <img
                        src="./assets/images/details/des-disc-1.webp"
                        alt="details"
                        className="w-full"
                      />
                    </div>
                    <div className="col-span-1">
                      <img
                        src="./assets/images/details/des-disc-2.webp"
                        alt="details"
                        className="w-full"
                      />
                    </div>
                  ...
                  <ul>
                    <li>
                      <i className="bi bi-check-circle" /> Professional Tour
                      Guide
                    </li>
                    <li>
                  ...
                  <ol className="custom_order__list">
                    <li>
                      ...
                      <div className="list__content">
                        ...
                        <p>
                          Qui ad idque soluta deterruisset, nec sale pertinax
                          mandamus et. Eu mei soluta scriptorem dissentiet,
                          sensibus cotidieque. Ne per malorum vivendum
                          principes, congue imperdiet cu vel. Sit cu stet autem
                          eligendi, eros reprimique mel id, no pri tation
                          altera. At soluta fierent laboramus eum.
                        </p>
                      </div>
                    </li>
                    <li>
                ...
                <div className="disc__bottom mt-[10px] lg:pt-6 lg:pb-6 pt-5 pb-5 border-t border-b border-stock-2 flex items-center justify-between flex-wrap gap-3">
                  <div className="flex items-center flex-wrap gap-3">
                    <h5 className="text-dark-1 lg:text-2md text-md font-semibold">
                      Popular Tags:{" "}
                    </h5>
                    <ul className="flex flex-wrap gap-2">
                      <li>
                        <a
                          href="#"
                          className="text-dark-3 duration-200 hover:text-primary-1 lg:text-base text-sm font-medium"
                        >
                          Travel,
                        </a>
                      </li>
                  ...
                  <button
                    ...
                    className="text-dark-2 gap-2 flex items-center lg:text-md text-base hover:text-primary-1 duration-200"
                  >
                  ...
                  <ul>
                    <li className="bg-[#FFE3EB] bg-opacity-50 lg:px-base px-5 lg:py-base py-5 flex md:flex-row flex-col">
                      <div className="md:mr-5 mb-4 md:mb-0 lg:w-[100px] w-16 shrink-0">
                        <img
                          src="./assets/images/blog/com-2.webp"
                          alt="commentor"
                          className="w-full"
                        />
                      </div>
                      <div className="grow">
                        <div className="flex justify-between items-center">
                          ...
                          <a
                            href="#"
                            className="flex text-primary-1 gap-[6px] lg:text-md"
                          >
                            {" "}
                            <div className="bi bi-reply" /> Reply
                          </a>
                        </div>
                        <p className="regular-text-v1 lg:mt-3 mt-2 !leading-[1.6] !pb-0">
                          Duis id interdum ex, eu accumsan massa. Fusce vel nibh
                          diam. Nulla ultrices ex at erat pharetra, vitae
                          viverra mauris condimentum. Sed ullamcorper dignissim
                          enim, vel egestas lacus tincidunt ac.
                        </p>
                      </div>
                    </li>
                    <ul className="lg:mt-[35px] mt-7 lg:ml-10 ml-8">
                      <li className="bg-[#FFE3EB] bg-opacity-50 lg:px-base px-5 lg:py-base py-5 flex md:flex-row flex-col">
                        <div className="md:mr-5 mb-4 md:mb-0 lg:w-[100px] w-16 shrink-0">
                          <img
                            src="./assets/images/blog/com-1.webp"
                            alt="commentor"
                            className="w-full"
                          />
                        </div>
                        <div className="grow">
                          ...
                          <p className="regular-text-v1 lg:mt-3 mt-2 !leading-[1.6] !pb-0">
                            Duis id interdum ex, eu accumsan massa. Fusce vel
                            nibh diam. Nulla ultrices ex at erat pharetra, vitae
                            viverra mauris condimentum. Sed ullamcorper
                            dignissim enim, vel egestas lacus tincidunt ac.
                          </p>
                        </div>
                      </li>
                    </ul>
            ...
            <div className="lg:col-span-4 col-span-12">
              <aside className="widget widget_search">
                <form action="#">
                  <div className="flex">
                    <input
                      type="text"
                      className="w-full lg:h-[55px] h-[48px] border border-primary-1 bg-transparent grow outline-none px-5 py-2 placeholder:text-dark-3 text-dark-2 text-[15px] focus:border-secondary-1"
                      placeholder="Search Here"
                    />
                    <button
                      aria-label="search submit"
                      type="submit"
                      className="shrink-0 lg:h-[55px] h-[48px] bg-primary-1 w-14 flex justify-center items-center duration-300 hover:bg-secondary-1"
                    >
                      <svg
                    ...
                    <div className="grow">
                      <h5 className="lg:text-17px text-base font-semibold leading-[1.64] group-hover:text-primary-1 duration-200 fixed-title">
                        <Link href="/blog-details">
                          The Most Underrated European Cities, according to
                          google you should know
                        </Link>
                      </h5>
                      <div className="text-dark-3 text-sm mt-1">
                        September 23, 1999
                      </div>
                    </div>
                  </li>
              ...
              <aside className="widget widget_category lg:mt-[50px] mt-10">
                ...
                <ul>
                  <li className="lg:mt-5 mt-4 first:lg:mt-0 first:mt-0">
                    <Link
                      href="/package-sidebar"
                      className="lg:text-md text-base text-dark-2 font-medium leading-[1.44] font-serif duration-200 hover:text-primary-1 "
                    >
                      Adventure (03)
                    </Link>
                  </li>
              ...
              <aside className="widget widget_tags lg:mt-[50px] mt-10">
                ...
                <ul>
                  <li className="inline-block mt-4 mr-5 last:mr-0">
                    <Link
                      href="/package-sidebar"
                      className="duration-200 hover:text-primary-1 lg:text-md text-base text-dark-2 font-medium leading-[1.3] hover:underline hover:underline-offset-1"
                    >
                      Travel,
                    </Link>
                  </li>
