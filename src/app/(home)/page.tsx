...
const handleSubmit = async () => {
  ...
  const [showModal, setShowModal] = useState(false); // Set to true to show modal by default
  const handleSubscribe = (path: string): any => {
    setRedirect(path);
    setShowModal(true);
  }
    ...
    <main className="bg-[#121316]">
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white w-full max-w-[20rem] mx-auto px-base py-base">
            ...
            <h4 className="text-zinc lg:text-[25px] text-2md  font-semibold leading-1.35">Lets subscribe before procceding,</h4>
            <div className="mt-9">
            ...
            <button aria-label="login form"  onClick={handleSubmit} className="btn_primary__v1 uppercase !w-full justify-center lg:mt-5 mt-4">
              Subscribe
